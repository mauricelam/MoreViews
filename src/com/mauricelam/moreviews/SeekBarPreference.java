...
public class SeekBarPreference extends Preference implements
	...
	private static final String NSSCHEME = "http://moreviews.mauricelam.com";
	...
	private void setValuesFromXml(AttributeSet attrs) {
		...
		mMinValue = attrs.getAttributeIntValue(NSSCHEME, "min", 0);

		mUnitsLeft = getAttributeStringValue(attrs, NSSCHEME, "unitsLeft",
				"");
		String units = getAttributeStringValue(attrs, NSSCHEME, "units", "");
		mUnitsRight = getAttributeStringValue(attrs, NSSCHEME, "unitsRight",
				units);

		try {
			String newInterval = attrs.getAttributeValue(NSSCHEME,
					"interval");
			if (newInterval != null)
